...
function loadInitial(): Proyecto {
  try {
    ...
    // guardado en este dispositivo y se arranca de nuevo con el dato
    // fresco — si no, una corrección posterior nunca llegaría a verse.
...
/** Guarda todo en este dispositivo (localStorage). Pensada para un único
 * usuario a cargo de la carga de datos — no sincroniza entre dispositivos. */
